...
public class RegisterActivity extends ActionBarActivity {
    ...
    private static String url_all_guidelines = "http://192.168.43.175/Hobbyix/adding_user.php";
    ...
    public void onclickregisteremail(View view)
    {
        String initaltext=email.getText().toString();
        if(firstemail==0|| initaltext.equals("username@domain.com")==true)
            email.setText("");
        firstemail++;

    }
    public void onclickregisterpassword(View view)
    {
        String initaltext=password.getText().toString();

        if(firstpassword==0|| initaltext.equals("password")==true)
            password.setText("");
        firstpassword++;

    }
    public void onclickregisterfullname(View view)
    {
        String initaltext=fullname.getText().toString();

        if(firstfullname==0|| initaltext.equals("John Smith")==true)
            fullname.setText("");
        firstpassword++;

    }
    public void onclickregisterphoneno(View view)
    {
        String initaltext=phoneno.getText().toString();

        if(firstphoneno==0||initaltext.equals("+91-1234567890")==true)
            phoneno.setText("");
        firstphoneno++;
                ...
                if(json.getInt("success")==1)
                {
                  ...
                  //  Toast.makeText(getApplicationContext(), "Registration Successful", Toast.LENGTH_SHORT).show();
                   Log.e("Registered success","sdasd");
                    Intent OpenLogin = new Intent(getApplicationContext(), Welcome.class);
